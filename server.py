...
def respect():
    ...
    if prediction[0] == 2:
            result = 'Your Depression test result : Moderate Depression (Kindly go to the Explore Section)'
    if prediction[0] == 3:
            result = 'Your Depression test result : Moderately severe Depression (Kindly go to the Explore Section)'
    if prediction[0] == 4:
            result = 'Your Depression test result : Severe Depression (Kindly go to Explore Section)'
